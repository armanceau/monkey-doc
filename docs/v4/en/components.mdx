...
<div className="flex flex-wrap gap-3 my-4">
  ...
  <LinkButton href="/getting-started" variant="outline">Read the docs</LinkButton>
  <LinkButton href="/getting-started" variant="ghost">Learn more</LinkButton>
</div>

<div className="flex flex-wrap gap-3 my-4">
  <LinkButton href="/getting-started" size="sm">Small</LinkButton>
  <LinkButton href="/getting-started" size="md">Medium</LinkButton>
  <LinkButton href="/getting-started" size="lg">Large</LinkButton>
</div>
...
<BarChart
  labels={["Jan", "Feb", "Mar"]}
  datasets={[
    { label: "Views", data: [4200, 5800, 4900] },
    { label: "Visitors", data: [2100, 3200, 2700] }
  ]}
  title="Monthly traffic"
/>
```
